...
import Table from '../Carton activity/Table'; // Shared Table component
...
const formatDateOnly = (dateTime) => {
  ...
  const handleView = (row) => {
    navigate(`/lab-dip/view/${row.labdip_id}`);
  };


  // Column config
  const columns = [
    { key: 'labdip_id', header: 'ID', render: (row) => row.labdip_id },
    {
      key: 'category',
      header: 'Category',
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 mx-auto">
      ...
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Lab Dip</h1>
