...
function PackagingSpecForm() {
  ...
  // };
    ...
    try {
      ...
      // as the artwork's first comment right after creation.
      ...
      if (remarkText || remarkAttachment) {
        ...
        try {
          ...
          // Artwork was created fine — a failed remark shouldn't block
          // the flow, just let the user know so they can re-add it.
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-5 p-5">
                {group.fields.map((f, fi) => (
                  ...
                  />
                    ...
                    {/* Reference attachment / remark — same UI as the detail
              page's Comments section, so an Excel table pasted here
              looks identical there too. */}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 mb-5">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-start">
              <div
                ...
                data-placeholder="Add any reference notes here, or paste an Excel table..."
